...
describe('routerMatcher.resolve', () => {
  ...
  function assertRecordMatch(
    ...
    resolved.params = resolved.params || ('params' in location ? location.params : {});
      ...
      const children = [
        {
          ...
          name: 'nested',
          alias: 'o',
          children: [{ path: 'two', alias: 't', name: 'nestednested', component }],
        },
        {
          path: 'other',
          alias: 'otherAlias',
  ...
  describe('locationAsPath', () => {
    ...
    it('resolves a path with multiple params', () => {
      assertRecordMatch(
        ...
        { path: '/users/essor/hey' },
        { name: 'User', params: { id: 'essor', other: 'hey' } },
      );
    });
    ...
    it('resolves a path with multiple params but no name', () => {
      assertRecordMatch(
        ...
        { path: '/users/essor/hey' },
        { name: undefined, params: { id: 'essor', other: 'hey' } },
      );
    });
  ...
  describe('locationAsName', () => {
    ...
    it('matches a name and fill params', () => {
      assertRecordMatch(
        ...
        { name: 'UserEdit', params: { id: 'essor', role: 'admin' } },
        { name: 'UserEdit', path: '/users/essor/m/admin' },
      );
    });

    it('throws if the named route does not exists', () => {
      expect(assertErrorMatch({ path: '/', components }, { name: 'Home' })).toMatchSnapshot();
    });
  ...
  describe('locationAsRelative', () => {
    ...
    it('replace params even with no name', () => {
      ...
      assertRecordMatch(
        record,
        { params: { id: 'essor', role: 'admin' } },
        { name: undefined, path: '/users/essor/m/admin' },
        {
