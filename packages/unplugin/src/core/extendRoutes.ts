...
export class EditableTreeNode {
  ...
  /**
   * Return a Map of the files associated to the current route. The key of the map represents the name of the view (essor
  ...
  /**
   * Meta property of the route as an object. Note this property is readonly and will be serialized as JSON.
   */
  ...
  /**
   * Override the meta property of the route. This will discard any other meta property defined through
   * `definePage()`/`defineRoute()` or through other means. If you want to keep existing meta properties, use
   * `addToMeta`.
   * @see {@link addToMeta}
   */
  ...
  set path(path: string) {
    ...
    // that matches the behavior of node.insert('path', 'file.tsx') that also adds it
